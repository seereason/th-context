...
data SetDifferences a = SetDifferences {unexpected :: Set a, expected :: Set a} deriving (Eq, Ord, Show)

setDifferences :: Ord a => Set a -> Set a -> SetDifferences a
setDifferences expected' actual = SetDifferences {unexpected = Set.difference actual expected', expected = Set.difference expected' actual}
